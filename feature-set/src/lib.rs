...
impl FeatureSet {
    ...
    pub fn runtime_features(&self) -> SVMFeatureSet {
        SVMFeatureSet {
            ...
            disable_inflation: self.is_active(&disable_inflation::id()),
        }
    }
}
...
pub mod disable_inflation {
    solana_pubkey::declare_id!("EpAefNdWbk4HhbfD5rYYbyawuy4cJU8rbKu5idwKdquY");
}
...
pub static FEATURE_NAMES: LazyLock<AHashMap<Pubkey, &'static str>> = LazyLock::new(|| {
    [
        ...
        (disable_inflation::id(), "DISABLE INFLATION"),
